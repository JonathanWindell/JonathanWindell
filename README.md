### About Me
[Linkedin](https://www.linkedin.com/in/jonathan-windell-418a55232/) | [Portfolio](https://portfolio.jonathans-labb.org/)
...
- Automation: Orchestrating workflows and self-hosted services via n8n.
...
| :--- | :--- | :--- | :--- |
| [**API Shell**](https://github.com/JonathanWindell/API-Shell) | CLI utility for streamlined REST API interaction and testing. | `Python` `CLI` | ![Active](https://img.shields.io/badge/Status-Active-success?style=flat-square) |
| [**Javalite**](https://github.com/JonathanWindell/Javalite) | Lightweight Java utility library for core development tasks. | `Java` `Core` | ![Active](https://img.shields.io/badge/Status-Active-success?style=flat-square) |
| [**Logthread**](https://github.com/JonathanWindell/Logthread) | High-performance multi-threaded logging implementation. | `Python` `JavaScript` | ![Updates](https://img.shields.io/badge/Status-Updates-orange?style=flat-square) |
...
| **Infrastructure & Security** | ![n8n](https://img.shields.io/badge/n8n-FF6D5B?logo=n8n&logoColor=white) ![Nmap](https://img.shields.io/badge/Nmap-00AEEF?logo=nmap&logoColor=white) ![Docker](https://img.shields.io/badge/Docker-2496ED?logo=docker&logoColor=fff) ![Prometheus](https://img.shields.io/badge/Prometheus-E6522C?logo=prometheus&logoColor=white) ![Git](https://img.shields.io/badge/Git-F05032?logo=git&logoColor=fff) ![Ubuntu](https://img.shields.io/badge/Ubuntu-E95420?logo=ubuntu&logoColor=white) ![Windows](https://custom-icon-badges.demolab.com/badge/Windows-0078D6?logo=windows11&logoColor=white) |
| **Frameworks & Testing** | ![FastAPI](https://img.shields.io/badge/FastAPI-009485.svg?logo=fastapi&logoColor=white) ![Pydantic](https://img.shields.io/badge/Pydantic-E92063?logo=Pydantic&logoColor=white) ![Pytest](https://img.shields.io/badge/Pytest-fff?logo=pytest&logoColor=000) ![JUnit5](https://img.shields.io/badge/JUnit5-C21325?logo=junit5&logoColor=fff) |
| **Databases** | ![SQL Server](https://custom-icon-badges.demolab.com/badge/Microsoft%20SQL%20Server-CC2927?logo=mssqlserver-white&logoColor=white) ![SQLite](https://img.shields.io/badge/SQLite-%2307405e.svg?logo=sqlite&logoColor=white) ![Postgres](https://img.shields.io/badge/Postgres-%23316192.svg?logo=postgresql&logoColor=white) ![Redis](https://img.shields.io/badge/Redis-%23DD0031.svg?logo=redis&logoColor=white) |
| **Workflow** | ![VS Code](https://custom-icon-badges.demolab.com/badge/Visual%20Studio%20Code-0078d7.svg?logo=vsc&logoColor=white) ![Visual Studio](https://custom-icon-badges.demolab.com/badge/Visual%20Studio-5C2D91.svg?&logo=visualstudio&logoColor=white) ![Obsidian](https://img.shields.io/badge/Obsidian-%23483699.svg?&logo=obsidian&logoColor=white) |

### Ask Me About
Anything related to the tech sector, homelabbing, or my outdoor hobbies. I believe that constant learning is the only way to advance—so let’s learn something new together.
